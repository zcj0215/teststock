...
def generate_signals(data):
    ...
    signals['mdibuy_signal'] = ((((signals['pdi'] > 20)&(signals['pdi'].shift(1).fillna(method="ffill") <=20)&(signals['vol']>signals['vol'].shift(1).fillna(method="ffill")))|((signals['pdi'] > signals['mdi']) & (signals['pdi'].shift(1).fillna(method="ffill") < signals['mdi'].shift(1).fillna(method="ffill")) & (signals['mdi'] < 20) & (signals['pdi'] < 30)&(signals['vol']>signals['vol'].shift(1).fillna(method="ffill"))&((signals['close']>signals['close'].shift(1).fillna(method="ffill"))&(signals['close'].shift(1).fillna(method="ffill")>signals['close'].shift(2).fillna(method="ffill"))))|((signals['mdi'] < signals['adxr'])&(signals['mdi'].shift(1).fillna(method="ffill") > signals['adxr'].shift(1).fillna(method="ffill"))&(signals['pdi'] < signals['mdi'])&(signals['pdi'] < signals['adx'])&(signals['pdi'] < signals['adxr'])&(signals['pdi']>signals['pdi'].shift(1).fillna(method="ffill"))&(signals['mdi']>50)&(signals['pdi']<10))| ((signals['adx'] > signals['adxr'])&(signals['adx'].shift(1).fillna(method="ffill") < signals['adxr'].shift(1).fillna(method="ffill"))&(signals['adx']<20)&(signals['adxr']<20)&(signals['pdi'] > signals['mdi'])&(signals['pdi']>20))|((signals['pdi']<10)&(signals['pdi']>signals['pdi'].shift(1).fillna(method="ffill"))&(signals['mdi']>50)&(signals['adx']>60)&(signals['adx']<signals['adx'].shift(1).fillna(method="ffill"))&(signals['adx'] < signals['adxr'])&(signals['adx'].shift(1).fillna(method="ffill")>signals['adxr'].shift(1).fillna(method="ffill"))))).astype(int)
    signals['mdisell_signal'] = ((((signals['mdi'] > 20)&(signals['mdi'].shift(1).fillna(method="ffill") <=20)&(signals['vol']<signals['vol'].shift(1).fillna(method="ffill")))|((signals['mdi'] > signals['pdi']) & (signals['mdi'].shift(1).fillna(method="ffill") < signals['pdi'].shift(1).fillna(method="ffill")) & (signals['pdi'] < 20)&(signals['mdi'] < 30)&(signals['vol']<signals['vol'].shift(1).fillna(method="ffill")))| ((signals['pdi'] < signals['adxr']) & (signals['pdi'].shift(1).fillna(method="ffill") > signals['adxr'].shift(1).fillna(method="ffill"))&(signals['mdi'] < signals['pdi'])&(signals['mdi'] < signals['adx'])&(signals['mdi'] < signals['adxr'])&((signals['mdi']>signals['mdi'].shift(1).fillna(method="ffill")))&(signals['pdi']>40)&(signals['mdi']<10))|((signals['adx'] > signals['adxr']) & (signals['adx'].shift(1).fillna(method="ffill") < signals['adxr'].shift(1).fillna(method="ffill"))&(signals['adx']<20)&(signals['adxr']<20)&(signals['mdi'] > signals['pdi'])&(signals['mdi']>20))|((signals['mdi']<10)&(signals['mdi']>signals['mdi'].shift(1).fillna(method="ffill"))&(signals['pdi']>50)&(signals['adx']>60)&(signals['adx']<signals['adx'].shift(1).fillna(method="ffill"))&(signals['adx'] < signals['adxr'])&(signals['adx'].shift(1).fillna(method="ffill")>signals['adxr'].shift(1).fillna(method="ffill"))))).astype(int)
