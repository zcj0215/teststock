...
urlpatterns = [
    ...
    re_path(r'^(?P<code>\d+)$', astocks_views.single),
    re_path(r'^stockSql/$',astocks_views.stockList),
    re_path(r'^search/$',astocks_views.search),
    re_path(r'^query/$',astocks_views.query),
    re_path(r'^enter/$', astocks_views.enter),
    re_path(r'^turnover/$', astocks_views.turnover),
