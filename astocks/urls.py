...
urlpatterns = [ 
    ...
    re_path(r'^edit_pick/(?P<id>\d+)/(?P<bytype>[a-z]+)/$', pick_views.EditStockChooseView.as_view(), name='edit_pick_by_type'), 
    re_path(r'^delete_pick/(?P<id>\d+)/(?P<bytype>[a-z]+)/$', pick_views.DeleteStockChooseByTypeView.as_view(), name='delete_pick_by_type'), 
    re_path(r'^edit_pick/(?P<id>\d+)/(?P<byboard>[a-z]+)/$', pick_views.EditStockChooseView.as_view(), name='edit_pick_by_board'), 
    re_path(r'^delete_pick/(?P<id>\d+)/(?P<byboard>[a-z]+)/$', pick_views.DeleteStockChooseByBoardView.as_view(), name='delete_pick_by_board'), 
